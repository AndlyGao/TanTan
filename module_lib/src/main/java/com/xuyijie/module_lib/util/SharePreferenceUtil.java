...
public class SharePreferenceUtil {
    public static void saveUser(Map<String, Object> user) {
        SharedPreferences.Editor editor = App.getInstance().getSharedPreferences("user", Context.MODE_PRIVATE).edit();
    ...
    public static void remove(String key) {
        SharedPreferences sp = App.getInstance().getSharedPreferences("user",
